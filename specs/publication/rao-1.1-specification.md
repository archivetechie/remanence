...
| Date | 2026-06-15 |
| Base | "Rem Archive Object (RAO) Format, Version 1.0" (normative for everything not restated here) |
...
normative additive delta on RAO 1.0: it specifies only what version 1.1
adds. The BCP 14 requirements language and all conventions of RAO 1.0
Section 2 apply to this document unchanged. Native hardlinks, symbolic
links, and empty directories are part of RAO 1.0's entry set — not
additions of 1.1 (see RAO 1.0 Sections 4.3.4, 4.6, and 4.7.2).
...
*Which* xattrs are preserved is an ingest/orchestration policy, defined
above this format: a built-in junk baseline
