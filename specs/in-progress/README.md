...
| REM-OBJECT | 1.0.0-draft.4 (scope move in progress) | 1.0.0-draft.3 | Section 1.6 states which rules belong in the specification. The rules it places outside the specification are still present. Later changes in this revision move them out, most to the REM Implementation and Operations Guide, which those changes also write. |
