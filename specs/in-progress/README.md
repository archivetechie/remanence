...
| REM-OBJECT | 1.0.0-draft.4 (scope move in progress) | 1.0.0-draft.3 | None yet. The copy is identical to the published text apart from its identifiers. |
| REM-ENCRYPT | 1.0.0-draft.4 (scope move in progress) | 1.0.0-draft.3 | None yet. The copy is identical to the published text apart from its identifiers. |
