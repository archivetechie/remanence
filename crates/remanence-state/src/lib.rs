...
pub use index::{
    ...
    RetireDriveOutcome, RetireTapeInput, RetireTapeOutcome, StoredWrapDescriptor,
    TapeAssignmentSnapshot, TapeFileRecord, TapeIoFenceInput, TapeIoFenceRecord,
    TapeJournalIndexInput, TapeJournalIndexReport, TapeKindFilter, TapePoolProjectionInput,
    TapePoolRecord, TapeRecord, TerminalFinalizationOutcome, TerminalFinalizationProjection,
