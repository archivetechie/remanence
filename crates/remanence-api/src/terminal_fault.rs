...
use remanence_parity::{
    PhysicalPositionHint, RawTapeSink, RawWriteOutcome, TerminalTailComponentKind,
    TerminalTailComponentPlan,
};
...
fn validate_component_cut(component: &str, cut: TerminalFaultCut) -> Result<(), String> {
    let valid = match component {
        "parity_closeout" => cut == TerminalFaultCut::AfterTerminalPrefix,
...
mod tests {
    use super::*;
    use remanence_parity::{ParityConfig, TerminalTailComponentKind};
